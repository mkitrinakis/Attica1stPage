(function( $ ) {
	...
	var weekDaysFromMonday = '<div>Δ</div><div>Τ</div><div>Τ</div><div>Π</div><div>Π</div><div>Σ</div><div>Κ</div>';
	var shortMonths = ["Ιαν", "Φεβ", "Μαρ", "Απρ", "Μαι", "Ιουν", "Ιουλ","Αυγ", "Σεπ", "Οκτ", "Νοε", "Δεκ"];
